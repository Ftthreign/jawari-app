<nav class="bg-white sticky top-0 z-50 shadow-md">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <ul class="hidden md:flex space-x-8">
            ...
            <li>
                <a href="#kesenian" wire:click.prevent="setActiveLink('Kesenian Banten')"
                    class="hover:text-lowPrimary text-base {{ $activeLink == 'Kesenian Banten' ? 'text-primary font-bold border-b-2 border-primary pb-1' : 'font-semibold' }}">
                    Kesenian Banten
                </a>
            </li>
            <li>
                <a href="#galeri" wire:click.prevent="setActiveLink('Galeri')"
            ...
            <li>
                <a href="#artikel" wire:click.prevent.prevent="setActiveLink('Artikel')"
